...
RSpec.describe 'RuboCop Norb Project', type: :feature do
      ...
      describe 'link to related issue' do
        ...
        it 'has a valid URL' do
          issues.each do |issue|
            ...
            pattern = %r{^https://github\.com/rubocop-hq/rubocop-norb/(?:issues|pull)/#{number}$} # rubocop:disable Metrics/LineLength
